...
import {fetchRecommendsCatalogue, fetchFriendsCatalogue} from '../apis/catalogue'
...
router.get('/api/catalogues/:eventId', fetchRecommendsCatalogue)
router.get('/api/catalogues/:eventId/friends', fetchFriendsCatalogue)
